...
<body>
	...
	<div id="wrapper">
    	...
    	<div class="container">
      		...
      		<div class="hero-unit">
        		<p>
                Warung IBU NANA merupakan warung online online yang menyediakan berbagai macam jenis makanan yang menyediakan pemesanan online dengan metode pembayaran cash on delivery dan transfer bank
				</p>
        		<p><a class="btn btn-warning btn-large" href="profil.php">Tentang Kami &raquo;</a></p>
      		...
      		<div class="row">
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-warning">Detail</a> <a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="index.html" class="btn btn-lg btn-Warung IBU NANA merupakan warung online online yang menyediakan berbagai macam jenis makanan yang menyediakan pemesanan online dengan metode pembayaran cash on delivery dan transfer bank">Beli &raquo;</a></div>
				...
				<div class="icons-box-vert-container">
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Warung Bu Nana siap mengirim pesanan anda secara gratis dengan radius maksimal 5 KM.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								<h3>Rasa Juara</h3>
								<p>Warung Bu Nana memiliki cita rasa yang berbeda dari warung sunda lainnya, di proses higienis dan dari bahan berkualitas.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
