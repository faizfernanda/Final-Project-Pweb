	...
	<div id="wrapper">
		...
		<div class="container">
            ...
            if (isset($_POST['input'])) {
                ...
                $path       = __DIR__ . "/../admin/gambar_customer/" . $nama_file;

                if (!file_exists(__DIR__ . "/../admin/gambar_customer/")) {
                    mkdir(__DIR__ . "/../admin/gambar_customer/", 0777, true);
                }
                ...
                if (mysqli_num_rows($cek) == 0) {
                    if (is_uploaded_file($tmp_file)) {
                        ...
                        $insert = mysqli_query($koneksi, "INSERT INTO customer (kd_cus, nama, alamat, no_telp, username, password, gambar) VALUES ('$kd_cus', '$nama', '$alamat', '$no_telp', '$username', '$password', '$nama_file')") or die(mysqli_error());
                        if ($insert) {
                ...
                <form role="formku" id="formku" method="post" action="" enctype="multipart/form-data">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><input name="foto" type="file" id="foto" class="form-control" required /></td>
                        </tr>
                        <tr>
                            <td></td>
